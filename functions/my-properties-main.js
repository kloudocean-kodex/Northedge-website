...
export function onRequest({request}){
  ...
  if(transaction==='lease') return redirect(request,'/rent');
  if(transaction==='sale'&&status==='sold') return redirect(request,'/sold');
  if(transaction==='sale') return redirect(request,'/buy');
